...
const submissionSchema = Joi.object({
  source_code: Joi.when('language_id', {
    is: MULTI_FILE_LANGUAGE_ID,
    then: Joi.string().max(config.execution.maxSourceSize).allow('', null).default(null),
    otherwise: Joi.string().max(config.execution.maxSourceSize).required(),
  }),
